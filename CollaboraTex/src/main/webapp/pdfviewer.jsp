...
<html dir="ltr" mozdisallowselectionprint moznomarginboxes>
    <head>
        ...
        <link rel="stylesheet" href="assets/lib/pdf.js/web/viewer.css"/>
        ...
        <script type="text/javascript" src="assets/lib/pdf.js/web/compatibility.js"></script>

        <!-- This snippet is used in production, see Makefile -->
        <link rel="resource" type="application/l10n" href="assets/lib/pdf.js/web/locale/locale.properties"/>
        <script type="text/javascript" src="assets/lib/pdf.js/web/l10n.js"></script>
        <script type="text/javascript" src="assets/lib/pdf.js/build/pdf.js"></script>

        <script type="text/javascript" src="assets/lib/pdf.js/web/debugger.js"></script>
        <script type="text/javascript" src="assets/lib/pdf.js/web/viewer.js"></script>

        <!-- set file url and worker -->
        <script>
            var jobId = <%= request.getParameter("jobId") %>;
            var fileUrl = getJobPdfUrl(jobId);
            var DEFAULT_URL = fileUrl;
            
            PDFJS.workerSrc = 'assets/lib/pdf.js/build/pdf.worker.js';
        </script>
    </head>
